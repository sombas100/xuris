        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <article className="rounded-3xl border border-white/10 bg-white/2.5 p-7 backdrop-blur-xl sm:p-8">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-white/55">
              <p>
                Applying for jobs can feel like sending applications into a
                black box. Candidates are often rejected without knowing whether
                their resume, keywords, experience or presentation held them
                back.
              </p>
              ...
              <p>
                ...
                cover letter generation and application tracking into one
                focused workspace.
              </p>
          ...
          <aside className="rounded-3xl border border-primary/20 bg-primary/5 p-7 backdrop-blur-xl sm:p-8">
            ...
            <p className="mt-4 leading-8 text-white/55">
              Xuris is an independent product built by Corey Clarke, a
              full-stack software engineer focused on creating practical,
