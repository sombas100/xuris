      ...
      <LegalContent>
        <LegalSection title="1. Information we collect">
          ...
          <p>
            ...
            including resumes, job descriptions, application records, notes and
        ...
        <LegalSection title="4. Data retention">
          <p>
            ...
            active or as needed to provide the service. Users may delete certain
            stored content through the application.
          </p>
        </LegalSection>
        ...
        <LegalSection title="8. Changes to this policy">
          <p>
            This policy may be updated as Xuris develops. Material changes will
            be reflected by updating the effective date.
          </p>
        </LegalSection>
      </LegalContent>
    </div>
